                                ...
                                <div className="col-lg-6">
                                    <div className="subscribe">
                                        <div>
                                            ...
                                            <p>Never Miss Anything From BlockPrint By Signing Up To Our Newsletter. </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                ...
                                <div className="sub-title">
                                    ...
                                    <div className="footer-contant">
                                        <ul className="contact-list">
                                            <li><i className="fa fa-map-marker"></i>Address: 18, Mahaveer Nagar-B, Railway Station Road, Sanganer, 
                                            Jaipur 302029
                                            </li>
                                            <li><i className="fa fa-phone"></i>Call Us: 9166019668</li>
                                            <li><i className="fa fa-envelope-o"></i>Email Us: <a
                                                href="#">Support@blockprint.com</a></li>
                        ...
                        <div className="row">
                            <div className="col-xl-6 col-md-6 col-sm-12">
                                <div className="footer-end">
                                    <p><i className="fa fa-copyright" aria-hidden="true"></i> 2019-2020 BlockPrint
                                        </p>
                                </div>
                            </div>
                            <div className="col-xl-6 col-md-6 col-sm-12">
